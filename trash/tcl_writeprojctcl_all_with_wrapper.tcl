...
#
# tcl_writeprojctcl_all_with_wrapper.tcl: Tcl script for re-creating project 'noc_proj'
#
# Generated by Vivado on Wed Dec 07 18:37:52 EET 2016
...
#
# 1. This project restoration tcl script (tcl_writeprojctcl_all_with_wrapper.tcl) that was generated.
#
...
#
#    "/home/tsotnep/ownCloud/workspace/vivado/noc_proj/noc_proj.srcs/sources_1/bd/design_1/design_1.bd"
#    "/home/tsotnep/ownCloud/workspace/vivado/noc_proj/noc_proj.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.vhd"
#
#*****************************************************************************************
...
set script_file "tcl_writeprojctcl_all_with_wrapper.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../workspace/vivado/noc_proj"]"

# Create project
create_project noc_proj ./noc_proj -part xc7z020clg484-1
...
set obj [get_projects noc_proj]
set_property "board_part" "em.avnet.com:zed:part0:1.3" $obj
set_property "compxlib.activehdl_compiled_library_dir" "$proj_dir/noc_proj.cache/compile_simlib/activehdl" $obj
set_property "compxlib.funcsim" "1" $obj
set_property "compxlib.ies_compiled_library_dir" "$proj_dir/noc_proj.cache/compile_simlib/ies" $obj
set_property "compxlib.modelsim_compiled_library_dir" "$proj_dir/noc_proj.cache/compile_simlib/modelsim" $obj
set_property "compxlib.overwrite_libs" "0" $obj
set_property "compxlib.questa_compiled_library_dir" "$proj_dir/noc_proj.cache/compile_simlib/questa" $obj
set_property "compxlib.riviera_compiled_library_dir" "$proj_dir/noc_proj.cache/compile_simlib/riviera" $obj
set_property "compxlib.timesim" "1" $obj
set_property "compxlib.vcs_compiled_library_dir" "$proj_dir/noc_proj.cache/compile_simlib/vcs" $obj
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../../workspace/vivado/ip_repo/noc2x2_1.0"]" $obj
...
set obj [get_filesets sources_1]
set files [list \
 "[file normalize "$origin_dir/../../workspace/vivado/noc_proj/noc_proj.srcs/sources_1/bd/design_1/design_1.bd"]"\
 "[file normalize "$origin_dir/../../workspace/vivado/noc_proj/noc_proj.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../../workspace/vivado/noc_proj/noc_proj.srcs/sources_1/bd/design_1/design_1.bd"
...
set file "$origin_dir/../../workspace/vivado/noc_proj/noc_proj.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
puts "INFO: Project created:noc_proj"
